...
class ConnectionEngine():
    ...
    def _build_connection_list(self, agent, connections, use_cpp=False):
        ...
        if(use_cpp):
            ...
            return runtime_gen_random_network
        else:
    ...
    def create_connections(self, use_cpp=False):
        ...
        if(use_cpp):
            ...
            if self.experiment:
                ...
                runtime = self._build_connection_list(0, connections, use_cpp)
            self.connections = connections
            logger.debug('- All connections made successfully with C++ optimization.')
            if self.experiment:
                return connections, runtime
            # Return the runtime for benchmarking
            return runtime
        else:
            ...
            if self.experiment:
                return connections, runtime
            # TODO(aogle): return a runtime for benchmarking
            return None
